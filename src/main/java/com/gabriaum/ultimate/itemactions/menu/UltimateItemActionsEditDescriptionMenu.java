...
public class UltimateItemActionsEditDescriptionMenu extends View {
    ...
    private final State<Pagination> paginationState = lazyPaginationState(
            context -> {
                ...
                return ultimateItemActions.getDescription();
            },
            (context, builder, index, lore) -> {
                ...
                builder.onRender(render -> render.setItem(
                        ...
                        .onClick(event -> {
                            updateParamService.removeDescription(
                                    ultimateItemActions,
                                    index - 1
                            );
    ...
    private void giveMetadataTo(Player player, String key) {
        player.setMetadata(
                "ultimate_item_actions_edit_description",
